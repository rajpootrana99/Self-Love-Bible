...
<head>
    ...
    <title>Self Love Bible | Dashboard</title>
    ...
    <!--end::Layout Skins -->
    <link rel="shortcut icon" href="{{ asset('assets/media/logos/slb.png') }}" />
...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="{{ route('index') }}">
            <img alt="Logo" src="{{ asset('assets/media/logos/slb.png') }}" />
        </a>
    </div>
...
<!-- Sticky Toolbar -->
{{--@include('admin.layouts.components.sticky-toolbar')--}}

<!-- Demo Panel -->
{{--@include('admin.layouts.components.demo-panel')--}}

<!-- Chat -->
{{--@include('admin.layouts.components.chat')--}}
